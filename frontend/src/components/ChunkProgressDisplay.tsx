  ...
  return (
    <div className={`bg-background border border-border rounded-lg p-4 ${className}`}>
          ...
          {progress.chunks
            ...
            .map((chunk) => (
              ...
              >
                ...
                {chunk.text_preview && (
                  <div className="mt-1 text-foreground/80 text-xs truncate">
                    "{chunk.text_preview}"
                  </div>
                )}
      ...
      {progress.completed_chunks === progress.total_chunks && progress.total_chunks > 0 && (
        <div className="mt-4 bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-800 rounded-lg p-3">
          <div className="flex items-center space-x-2">
...
export function ChunkProgressMini({ progress, className = '' }: { progress: ProcessingProgress; className?: string }) {
  ...
  return (
    <div className={`bg-muted/50 border border-border rounded-lg p-3 ${className}`}>
      ...
      <div className="w-full bg-muted-strong rounded-full h-1.5 mb-2">
        <div
