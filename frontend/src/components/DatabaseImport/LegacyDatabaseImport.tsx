        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-muted-strong disabled:cursor-not-allowed transition-colors"
            >
            ...
            <div className="p-3 bg-green-50 dark:bg-green-950/40 border border-green-200 dark:border-green-800 rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-green-800 dark:text-green-300">Database found!</p>
          ...
          <div className="flex flex-col gap-3 pt-2">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-muted-strong disabled:cursor-not-allowed transition-colors"
            >
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full px-4 py-3 border-2 border-input text-foreground/80 rounded-lg hover:bg-muted/50 disabled:bg-muted disabled:cursor-not-allowed transition-colors"
            >
