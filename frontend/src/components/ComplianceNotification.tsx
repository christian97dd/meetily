    ...
    >
      <div className="bg-background border border-border rounded-lg shadow-lg p-3">
        ...
        <div className="flex items-start justify-between mb-2">
          ...
          <button
            onClick={handleClose}
            className="text-muted-foreground/70 hover:text-foreground transition-colors p-0.5 rounded hover:bg-accent"
          >
            <X className="h-3 w-3" />
          </button>
        </div>
        ...
        <div className="mb-2">
          ...
          <div className="bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 rounded p-1">
