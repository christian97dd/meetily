        ...
        <Alert variant="destructive" className="border-amber-400 bg-amber-50 dark:bg-amber-950/40">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-amber-900 dark:text-amber-300 bg-amber-100 dark:bg-amber-900/40 hover:bg-amber-200 dark:hover:bg-amber-900/60 rounded-md transition-colors disabled:opacity-50"
            >
