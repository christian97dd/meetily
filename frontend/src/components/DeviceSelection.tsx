...
export function DeviceSelection({ selectedDevices, onDeviceChange, disabled = false }: DeviceSelectionProps) {
    ...
    return (
      <div className="p-4 space-y-4">
        <div className="animate-pulse">
          <div className="h-4 bg-muted-strong rounded w-1/3 mb-4"></div>
          <div className="h-10 bg-muted-strong rounded mb-3"></div>
          <div className="h-10 bg-muted-strong rounded"></div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {error && (
        <div className="p-3 text-sm text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-800 rounded-md">
          {error}
        </div>
      )}
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="mic-selection" className="text-sm font-medium text-foreground/80">
              Microphone
            </Label>
          </div>
          <Select
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="system-selection" className="text-sm font-medium text-foreground/80">
              System Audio
            </Label>
          </div>
