...
export function OnboardingContainer({
  ...
  return (
    <div className="fixed inset-0 bg-muted/50 flex items-center justify-center z-50 overflow-hidden">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    canGoPrevious && step !== 1
                      ? 'hover:bg-muted/50 hover:shadow-md hover:scale-110 text-foreground/80'
