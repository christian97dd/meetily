  ...
  if (loading) {
    return (
      <div className="animate-pulse">
        <div className="h-4 bg-muted-strong rounded w-1/4 mb-4"></div>
        <div className="h-8 bg-muted-strong rounded mb-4"></div>
      </div>
    );
  }
        ...
        <div className="space-y-4">
          <div className="p-4 border rounded-lg bg-muted/50">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-sm border border-input rounded-md hover:bg-muted/50 transition-colors"
            >
        ...
        <div className="border-t pt-6">
          ...
          {isRecording && (
            <p
              role="status"
              aria-live="polite"
              className="text-sm text-amber-700 dark:text-amber-300 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 rounded-md p-2 mb-4"
            >
