...
export function AudioBackendSelector({
  ...
  if (loading) {
    return (
      <div className="animate-pulse">
        <div className="h-4 bg-muted-strong rounded w-32 mb-2"></div>
  ...
  return (
    <div className="space-y-2">
      ...
      {error && (
        <div className="p-2 text-xs text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-800 rounded-md">
          {error}
        </div>
      )}
          ...
          return (
            <label
              ...
              className={`flex items-start p-3 border rounded-lg transition-all ${
                currentBackend === backend.id
                  ...
                  : 'border-input hover:border-muted-foreground/50 bg-background'
            ...
            >
              <input
                ...
                disabled={isDisabled}
                className="mt-1 h-4 w-4 text-blue-600 dark:text-blue-400 focus:ring-blue-500 border-input"
              />
