...
export function ModelManager({
  ...
  if (error) {
    return (
      <div className={`bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-800 rounded-lg p-4 ${className}`}>
      ...
      <div className="p-3">
                ...
                <AnimatePresence>
                  {isHovered && (
                    <motion.button
                      ...
                      className="text-muted-foreground/70 hover:text-red-600 dark:hover:text-red-400 transition-colors p-1"
        ...
        {downloadProgress !== null && (
          ...
          >
            <div className="flex items-center justify-between mb-2">
              ...
              {isCancelling ? (
                ...
                <button
                  ...
                  className="text-xs text-muted-foreground hover:text-red-600 dark:hover:text-red-400 font-medium transition-colors px-2 py-1 rounded hover:bg-red-50 dark:hover:bg-red-950/60"
            ...
            <div className="w-full h-2 bg-muted-strong rounded-full overflow-hidden">
              <motion.div
