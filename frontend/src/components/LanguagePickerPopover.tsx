...
export function LanguagePickerPopover({
  ...
  return (
    <div
      ref={containerRef}
      className="w-72 rounded-lg bg-background border border-border shadow-lg overflow-hidden"
      role="dialog"
    ...
    >
      ...
      <div className="max-h-80 overflow-y-auto py-1">
          ...
          <>
            ...
            {recentsResolved.map((opt) => (
              ...
              >
                <span>
                  {opt.label}{" "}
                  <span className="text-xs text-muted-foreground/70">({opt.code})</span>
                </span>
        ...
        {showAuto && (
          ...
          >
            <span className="flex flex-col">
              <span>Auto</span>
              {autoSubtitle && (
                <span className="text-xs font-normal text-muted-foreground/70">{autoSubtitle}</span>
              )}
            </span>
        ...
        {hasNoResults && (
          <div className="px-3 py-2 text-sm text-muted-foreground/70">No matches</div>
        )}
      </div>
    </div>
  );
