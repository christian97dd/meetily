  ...
  return (
    <>
      <div className="space-y-4">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2">
                  <code className="text-xs text-foreground/80 bg-background px-2 py-1 rounded border border-input font-mono flex-1 truncate">
                    {userId}
                  </code>
                  <Button
        ...
        <div className="flex items-start gap-2 p-2 bg-blue-50 dark:bg-blue-950/40 rounded border border-blue-200 dark:border-blue-800">
          ...
          <div className="text-xs text-blue-700 dark:text-blue-300">
            ...
            <button
              ...
              className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-200 underline hover:no-underline"
            >
              View Privacy Policy
            </button>
          </div>
