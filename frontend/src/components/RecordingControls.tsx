            ...
            <>
              {showPlayback ? (
                <>
                  ...
                  <div className="w-px h-6 bg-muted-strong mx-1" />
                  ...
                  <div className="flex items-center space-x-1 mx-2">
                    ...
                    <div
                      className="relative w-24 h-1 bg-muted-strong rounded-full"
                    >
                      <div
                  ...
                  <button
                    className="w-10 h-10 flex items-center justify-center bg-muted-strong rounded-full text-white cursor-not-allowed"
                    disabled
                  >
                    <Play size={16} />
                  </button>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className={`w-12 h-12 flex items-center justify-center ${isStarting || isProcessing || isValidatingModel || isStartingRecording ? 'bg-muted-foreground/50' : 'bg-red-500 hover:bg-red-600'
                        ...
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className={`w-10 h-10 flex items-center justify-center ${isPausing || isResuming || isStopping
                              ? 'bg-muted-strong border-2 border-input text-muted-foreground/70'
                              : 'bg-background border-2 border-input text-muted-foreground hover:border-muted-foreground/50 hover:bg-muted/50'
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className={`w-10 h-10 flex items-center justify-center ${isStopping || isPausing || isResuming || isStartingRecording ? 'bg-muted-foreground/50' : 'bg-red-500 hover:bg-red-600'
                              } rounded-full text-white transition-colors relative`}
                          >
                            <Square size={16} />
                            {isStopping && (
        ...
        {deviceError && (
          <Alert variant="destructive" className="mt-4 border-red-300 dark:border-red-800 bg-red-50 dark:bg-red-950/40">
            ...
            <button
              ...
              className="absolute right-3 top-3 text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-200 transition-colors"
