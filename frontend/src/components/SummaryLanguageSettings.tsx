...
export function SummaryLanguageSettings() {
  ...
  return (
    <div className="bg-background rounded-lg border border-border p-6 shadow-sm relative">
          ...
          return (
            ...
            >
              ...
              >
                <Pin
                  size={14}
                  className={isPinned ? 'text-blue-600 dark:text-blue-400' : 'text-muted-foreground/70'}
              ...
              <button
                ...
                className={`pr-2.5 pl-0.5 py-1 leading-none ${isPinned ? 'text-blue-400 hover:text-blue-700 dark:hover:text-blue-200' : 'text-muted-foreground/70 hover:text-foreground'}`}
              >
                ×
              </button>
            </span>
        ...
        <Popover open={pickerOpen} onOpenChange={setPickerOpen}>
          <PopoverTrigger asChild>
            <button
              ...
              className="inline-flex items-center gap-1 rounded-full border border-dashed border-input px-3 py-1 text-sm text-muted-foreground hover:border-muted-foreground/50 hover:text-foreground disabled:cursor-not-allowed disabled:opacity-50"
            >
              ＋ Add language
            </button>
          </PopoverTrigger>
